...
import (
	"context"
	schedmock "github.com/ohsu-comp-bio/funnel/compute/basic/mocks"
...
func newTestNode(conf config.Config) testNode {
	...
	conf.Backends.Basic.Node.WorkDir = workDir
	...
	n := &Node{
		...
		client:     s,
		log:        log,
		resources:  detectResources(conf.Backends.Basic.Node),
