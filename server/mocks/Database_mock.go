...
// QueueTask provides a mock function with given fields: _a0, _a1
func (_m *Database) QueueTask(_a0 context.Context, _a1 *tes.Task) (*scheduler.QueueTaskResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *scheduler.QueueTaskResponse
	if rf, ok := ret.Get(0).(func(context.Context, *tes.Task) *scheduler.QueueTaskResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
